...
export const metadata: Metadata = {
  ...
  description:
    "Votre demande a bien été reçue. Nos engagements écrits vous parviennent par courriel.",
  alternates: { canonical: "/professionnels/engagement/merci" },
    ...
    <main className="flex min-h-screen flex-col bg-background-subtle">
      ...
      <section className="section-px mx-auto flex w-full max-w-layout flex-1 flex-col items-center justify-center py-20">
        <div className="flex max-w-110 flex-col items-center gap-6 text-center">
          <p className="text-eyebrow text-primary">Notre engagement</p>
          <h1 className="text-h1">Demande envoyée</h1>
          <p className="text-secondary-foreground">
            Vous recevez nos engagements écrits par courriel, et un
            interlocuteur vous répond dans les 24 heures ouvrées. Si vous
