...
import { CorseInfoGrid } from "./info-grid";
import { CorseTips } from "./tips";

export default function CorseDestinationPage() {
  return (
    <main className="flex-1">
      <div className="relative">
        ...
        <HeroImageGallery
          ...
          description="Une montagne plongée dans la mer. Des criques que l'on rejoint en bateau privé, des bergeries préservées au cœur du maquis, des tables confidentielles où la cuisine raconte une mémoire insulaire. Chaque étape est pensée pour vous laisser respirer."
          images={[
            {
      ...
      <FeatureCardsSection
        ...
        description="Une île qui se révèle à qui prend le temps. Du sentier muletier aux calanques rouges, du bateau privé aux caves de granit, chaque expérience est pensée pour vous immerger dans une Corse intime et préservée."
      ...
      <FeatureCardsSection
        ...
        description="Nous avons soigneusement choisi les plus belles adresses de Corse — bergeries restaurées, villas en pierre, palaces discrets — pour vous offrir une expérience inoubliable."
      ...
      <BentoSection
        ...
        description="Un travel designer, expert de la Corse, façonne un voyage d'exception selon vos envies."
        cta={{ label: "Créer votre voyage", href: "/reserver" }}
        cards={[
          {
      ...
      <PlacesMapSection
        ...
        description="Que vous soyez amateur de randonnée, de plongée ou simplement en quête de silence, la diversité des paysages corses saura vous émerveiller."
        cta={{ label: "Créer votre voyage", href: "/reserver" }}
        initialZoom={7}
        places={[
          {
      ...
      <FaqSection
        ...
        items={[
          ...
          {
            question:
              "Combien de régions peut-on visiter en deux semaines ?",
            answer:
