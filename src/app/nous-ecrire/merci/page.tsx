...
export const metadata: Metadata = {
  title: "Message envoyé — Exuma",
  description:
    "Votre message a bien été reçu. Un interlocuteur Exuma vous répond sous 24 heures ouvrées.",
  alternates: { canonical: "/nous-ecrire/merci" },
    ...
    <main className="flex min-h-screen flex-col bg-background-subtle">
      ...
      <section className="section-px mx-auto flex w-full max-w-layout flex-1 flex-col items-center justify-center py-20">
        <div className="flex max-w-110 flex-col items-center gap-6 text-center">
          <p className="text-eyebrow text-primary">Nous écrire</p>
          <h1 className="text-h1">Message envoyé</h1>
          <p className="text-secondary-foreground">
            Un interlocuteur prend connaissance de votre message et vous
            répond dans les 24 heures ouvrées. Si vous préférez ne pas
