...
export const destination: Destination = {
  slug: "chine",
  subthemeSlugs: ["sites-historiques", "traditions-vivantes"],
  name: "Chine",
  placeKind: "country",
  country: "Chine",
...

    {
      ...
      duo: {
        left: {
          ...
          alt: "Table dressée en plein air sur le chemin de ronde de la Grande Muraille, face aux montagnes",
        },
        right: {
...

    {
      ...
      cards: defaultBento.cards.map((card, i) => ({
        ...
        image: {
          ...
          alt: [
            "Carte de l'itinéraire en Chine, de Pékin à Xi'an, Shanghai et aux montagnes du Sud-Ouest",
            ...
            "Conciergerie privée 24/7 pour un voyage en Chine : une travel designer à son bureau",
