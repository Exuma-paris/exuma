...
export const destination: Destination = {
  ...
  sections: [
...

    {
      ...
      description:
        "Trois adresses posées dans le paysage plutôt qu'en ville. Ce qu'on voit en ouvrant les yeux le matin fait partie du programme, autant que les journées elles-mêmes.",
