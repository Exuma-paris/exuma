...
| --- | --- | --- |
| Île Maurice | `maurice` | 25 / 25 |
| Polynésie française | `polynesie` | 24 / 24 |
| Tanzanie | `tanzanie` | 25 / 25 |

## Partiellement illustrées
...
| Argentine | `argentine` | 0 / 25 |
| Autriche | `autriche` | 0 / 25 |
| Bahamas | `bahamas` | 0 / 25 |
...
| Saint-Barthélemy | `saint-barthelemy` | 0 / 23 |
| Saint-Vincent-et-les-Grenadines | `saint-vincent-et-les-grenadines` | 0 / 24 |
| Sainte-Lucie | `sainte-lucie` | 0 / 24 |
...
| Turquie | `turquie` | 0 / 25 |
| Uruguay | `uruguay` | 0 / 25 |
| Vietnam | `vietnam` | 0 / 25 |
