# Reference images — Thaïlande

Chaque image de `public/destination/thailande/` a été produite en passant la photo de référence correspondante au prompt de `.claude/skills/destination-generator/gen-images.mjs` (Gemini 3 Pro Image), en mode **grade seul** : composition, cadrage, sujets, heure et météo préservés, seul le rendu colorimétrique change.

Les références ont été fournies par l'utilisateur (Rémi / collaborateurs), déclarées libres de droit. Pas d'URL source : les fichiers ont été déposés directement dans ce dossier.

| Output | Référence | Source | Statut |
| --- | --- | --- | --- |
...
| `xp-khao-yai.webp` | `xp-khao-yai-ref.jpg` | fournie (libre de droit) | OK |
...
Les binaires de référence sont gitignorés ; ce fichier est suivi.
