# Reference images — Islande

Each generated image in `public/destination/islande/` was produced by feeding the prompt baked into `.claude/skills/destination-generator/gen-images.mjs` to Gemini 3 Pro Image (Nano Banana Pro) alongside the corresponding reference photograph below.

Les références ont été fournies par l'utilisateur le 27 août 2026. Elles sont libres de droit ; l'URL d'origine n'a pas été conservée à la remise.

| Output | Reference file | Source URL | License |
| --- | --- | --- | --- |
| `hero-1.webp` | `hero-1-ref.png` | fournie par le client | libre de droit |
| `hero-2.webp` | `hero-2-ref.png` | fournie par le client | libre de droit |
| `hero-3.webp` | `hero-3-ref.png` | fournie par le client | libre de droit |
...
| `map-vik.webp` | `map-vik-ref.png` | fournie par le client | libre de droit |
| `map-skaftafell.webp` | `map-skaftafell-ref.png` | fournie par le client | libre de droit |
| `map-jokulsarlon.webp` | `map-jokulsarlon-ref.png` | fournie par le client | libre de droit |
| `map-heimaey.webp` | `map-heimaey-ref.png` | fournie par le client | libre de droit |
